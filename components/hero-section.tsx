          ...
          <div className="relative pt-24 md:pt-36">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mt-0 lg:mr-auto">
                <AnimatedGroup variants={transitionVariants}>
                  ...
                  >
                    <span className="text-foreground text-sm">
                      Start your journey with Cheems
                    </span>
                ...
                >
                  Modern Solutions for Dog Adoption
                </TextEffect>
                <TextEffect
                  per="line"
                  preset="fade-in-blur"
                ...
                >
                  A trusted platform that connects shelters with dog lovers
                  through simple, safe, and heartwarming adoptions.
                </TextEffect>
                ...
                >
                  ...
                  >
                    <Link href="#link">
                      <span className="text-nowrap">Start as a Shelter</span>
                    </Link>
                  </Button>
                </AnimatedGroup>
              </div>
